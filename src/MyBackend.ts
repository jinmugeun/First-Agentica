...
export class MyBackend {
  ...
  public async open(): Promise<void> {
    ...
    console.log(`🌐 Server is running on http://localhost:${MyConfiguration.API_PORT()}`);
    console.log(`📖 API Documentation: http://localhost:${MyConfiguration.API_PORT()}/editor`);
    console.log("📄 Upload PDF/DOCX files to generate reports!");
